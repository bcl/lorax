...
__EOF__
        ...
        rlAssertExists "/var/lib/lorax/composer/blueprints/git/workspace/master/beakerlib.toml"
    rlPhaseEnd
...
__EOF__
    ...
    rlPhaseStartTest "blueprints delete"
        ...
        rlAssertNotExists "/var/lib/lorax/composer/blueprints/git/workspace/master/beakerlib.toml"
    rlPhaseEnd
